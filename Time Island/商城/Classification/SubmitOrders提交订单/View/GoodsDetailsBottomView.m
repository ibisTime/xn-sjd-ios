...
-(UIButton *)shoppingButton
{
    if (!_shoppingButton) {
        ...
        _shoppingButton.frame = CGRectMake(SCREEN_WIDTH - 140, 4, 130, 44);
        [_shoppingButton setTitle:@"分期购买" forState:(UIControlStateNormal)];
        _shoppingButton.titleLabel.font = HGfont(16);
        _shoppingButton.backgroundColor = kHexColor(@"#F68646");
        [_shoppingButton setTitleColor:kWhiteColor forState:UIControlStateNormal];
