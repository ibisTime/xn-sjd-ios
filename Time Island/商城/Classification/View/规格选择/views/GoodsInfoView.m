...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //关闭按钮
        _closeButton = [JXUIKit buttonWithBackgroundColor:[UIColor whiteColor] imageForNormal:@"删除 灰色" imageForSelete:@"删除 灰色"];
        ...
        //价格
        _goodsPriceLabel = [JXUIKit labelWithBackgroundColor:WhiteColor textColor:kSJDMainTextColor textAlignment:NSTextAlignmentLeft numberOfLines:0 fontSize:0 font:[UIFont systemFontOfSize:14] text:@"197"];
