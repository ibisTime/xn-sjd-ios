...
-(instancetype)initWithFrame:(CGRect)frame andHeight:(float)height {
    ...
    if (self) {
        ...
        sureButton.sd_layout.leftSpaceToView(bgView, 15).rightSpaceToView(bgView, (kScreenWidth-15*3)/2+30).bottomSpaceToView(bgView, 10).heightIs(49);
        ...
        //kbottomHeight为了适配iphonex，不让按钮显示在x底部圆弧范围内
        buyButton.sd_layout.leftSpaceToView(sureButton, 15).rightSpaceToView(bgView, 15).bottomSpaceToView(bgView, 10).heightIs(49);
