...
#import "MallNavigationController.h"
#import "TLUserLoginVC.h"
#import "LangSwitcher.h"
#import "UIColor+theme.h"
#import "AppConfig.h"
@interface MallTabBarController ()<UITabBarControllerDelegate>
...
- (void)viewDidLoad {
    ...
    NSArray *titles = @[
                        ...
                        [LangSwitcher switchLang:@"商品分类" key:nil],
                        [LangSwitcher switchLang:@"购物车" key:nil],
                        [LangSwitcher switchLang:@"我的" key:nil]
                        ];
    NSArray *VCNames = @[@"MallVC",@"MallGoodsVC",@"MallShoppingVC",@"MallMineVC"];
              ...
              selectedImage:(NSString *)selectedImageName
{
    ...
    MallNavigationController *navigationController = [[MallNavigationController alloc] initWithRootViewController:vc];
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController {
    ...
    if ([AppConfig config].isUploadCheck) {
        ...
        if((idx == 0 || idx == 2 || idx == 3) && ![TLUser user].isLogin) {
            ...
            MallNavigationController *nav = [[MallNavigationController alloc] initWithRootViewController:loginVC];
