...
@interface TreeFieldTB()<UITableViewDelegate, UITableViewDataSource>

@end

static NSString *identifierCell = @"FiledCell";

@implementation TreeFieldTB
- (instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style {
    ...
    if (self = [super initWithFrame:frame style:style]) {
        ...
        [self registerClass:[TreeFiledCell class] forCellReuseIdentifier:identifierCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TreeFiledCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell forIndexPath:indexPath];
