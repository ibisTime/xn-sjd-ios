...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        [photoBtn setTitle:@"上传图片" forState:(UIControlStateNormal)];
//        [photoBtn SG_imagePositionStyle:(SGImagePositionStyleTop) spacing:10 imagePositionBlock:^(UIButton *button) {
//            [button setImage:[UIImage imageNamed:@"上传图片"] forState:(UIControlStateNormal)];
//        }];
    ...
    }else
    {
        ...
        [selectButton setImage:HGImage(@"删除 灰色") forState:(UIControlStateNormal)];
